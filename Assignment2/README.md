...
Below is a screen recording demonstrating the expected result for this assignment (If you can't visualze it, you can look at the video-1.mov file in the Assignment2 folder)

<video src="video-1.mov" controls width="480">
...
Note that we are using the Clock class to measure the time elapsed between frames and adding it to a variable that measures the absolute time since the beginning of the animation.
...
# Grade breakdown
1. Exercise 1: Fill in the whole cube. 5.0 points.
2. Exercise 2: Tilt the cubes 10 degrees to the left with respect to the previous cube in the stack. 5 points.
3. Exercise 3: Make the cubes taller using the scaling matrix transform. 5 points.
4. Exercise 4: Make the cube swing to the left and back to the center. 2.5 points.
5. Exercise 5: Finish the wirefreme cube, and replace the Mesh() cube by the new LineSegments cube. 5 points.
6. Exercise 6: Key interaction. 2.5 points.
